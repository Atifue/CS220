...
# Define a function incidence matrix provides incidence matrix for a graph
...
# [14] Define a function to assign random weights to the edges


# [15] Implement two classic Shortest-Path algorithms
# Dijskstra's Single Source Shortest Path (SSSP)
# Floyd's All-Pairs Shortest Path (APSP)


# [16] Refactor the code for relation-properties and vertex-properties into functions,
# and call it all from a do_graph().
